...
var t = (e, t) => () => (t || (e((t = { exports: {} }).exports, t), e = null), t.exports), n = /* @__PURE__ */ t(((e) => {
	...
	function Si(e, t, n, r, i, a) {
		...
		if (r = e, typeof e == "function") yi(e) && (o = 1);
			...
			case oe: return e = vi(31, n, t, i), e.elementType = oe, e.lanes = a, e;
			...
			case ie: return e = vi(19, n, t, i), e.elementType = ie, e.lanes = a, e;
			default:
	...
	function Ga(e) {
		...
		function l(e, t, n, r) {
			var a = n.type;
			return a === b ? d(e, t, n.props.children, r, n.key) : t !== null && (t.elementType === a || typeof a == "object" && a && a.$$typeof === C && Ia(a) === t.type) ? (t = i(t, n.props), Ua(t, n), t.return = e, t) : (t = Si(n.type, n.key, n.props, null, e.mode, r), Ua(t, n), t.return = e, t);
		}
		function u(e, t, n, r) {
		...
		function f(e, t, n) {
			...
			if (typeof t == "object" && t) {
				switch (t.$$typeof) {
					...
					case C: return t = Ia(t), f(e, t, n);
				}
				if (de(t) || le(t)) return t = Ci(t, e.mode, n, null), t.return = e, t;
		...
		function p(e, t, n, r) {
			...
			if (typeof n == "object" && n) {
				switch (n.$$typeof) {
					...
					case C: return n = Ia(n), p(e, t, n, r);
				}
		...
		function m(e, t, n, r, i) {
			...
			if (typeof r == "object" && r) {
				switch (r.$$typeof) {
					...
					case C: return r = Ia(r), m(e, t, n, r, i);
				}
			...
			if (typeof a == "object" && a && a.type === b && a.key === null && (a = a.props.children), typeof a == "object" && a) {
				switch (a.$$typeof) {
						...
						a: {
							for (var l = a.key; r !== null;) {
								if (r.key === l) {
									...
									} else if (r.elementType === l || typeof l == "object" && l && l.$$typeof === C && Ia(l) === r.type) {
					...
					case y:
						...
						return o(e);
					case C: return a = Ia(a), _(e, r, a, s);
				}
	...
	function ko(e, t, n, r, i, a) {
		return bo = a, P = t, t.memoizedState = null, t.updateQueue = null, t.lanes = 0, T.H = e === null || e.memoizedState === null ? Gs : Ks, Co = !1, a = n(r, i), Co = !1, So && (a = jo(t, n, r, i)), Ao(e), a;
	}
	function Ao(e) {
		T.H = Ws;
	...
	function Ro(e) {
		var t = To;
		return To += 1, Eo === null && (Eo = []), e = Fa(Eo, e, t), t = P, (I === null ? t.memoizedState : I.next) === null && (t = t.alternate, T.H = t === null || t.memoizedState === null ? Gs : Ks), e;
	}
	function zo(e) {
		if (typeof e == "object" && e) {
	...
	function Bo(e) {
		...
		if (t ??= {
			data: [],
			index: 0
		}, n === null && (n = Lo(), P.updateQueue = n), n.memoCache = t, n = t.data[t.index], n === void 0) for (n = t.data[t.index] = Array(e), r = 0; r < e; r++) n[r] = se;
		return t.index++, n;
	}
	function Vo(e, t) {
	...
	function $o(e, t, n, r, i) {
		...
		if (e = t.action, e !== null) {
			...
			T.T === null ? a.isTransition = !1 : n(!0), r(a), n = t.pending, n === null ? (a.next = t.pending = a, es(t, a)) : (a.next = n.next, t.pending = n.next = a);
		}
	}
	function es(e, t) {
	...
	function wu(e, t) {
		P = null, T.H = Ws, t === Aa || t === Ma ? (t = Ra(), J = 3) : t === ja ? (t = Ra(), J = 4) : J = t === cc ? 8 : typeof t == "object" && t && typeof t.then == "function" ? 6 : 1, Hl = t, K === null && (Y = 1, nc(e, Oi(t, e.current)));
	}
	function Tu() {
		var e = fo.current;
	...
	function ku(e, t, n) {
		...
		while (1);
		return t && e.shellSuspendCounter++, na = ta = null, W = r, T.H = i, T.A = a, K === null && (G = null, q = 0, ui()), o;
	}
	function Au() {
		for (; K !== null;) Nu(K);
	}
	function ju(e, t) {
		...
		while (1);
		return na = ta = null, T.H = r, T.A = i, W = n, K === null ? (G = null, q = 0, ui(), Y) : 0;
	}
	function Mu() {
		for (; K !== null && !Ne();) Nu(K);
	}
...
function h({ hass: e }) {
	let t = f[pe(e)], n = (0, u.useRef)(e), r = (0, u.useRef)(!1), [i, a] = (0, u.useState)(null), [o, s] = (0, u.useState)(!1), [c, l] = (0, u.useState)(!1);
	n.current = e;
...
function g({ hass: e, snapshot: t, refresh: n, t: r }) {
	let [i, a] = (0, u.useState)(""), [o, s] = (0, u.useState)([]), [c, l] = (0, u.useState)(!1), [d, f] = (0, u.useState)([]), [p, h] = (0, u.useState)(null), [g, v] = (0, u.useState)(!1), [x, ee] = (0, u.useState)(!1), [ae, C] = (0, u.useState)(null), [oe, ce] = (0, u.useState)(!1), le = t.devices.filter((e) => e.can_bind), w = le.find((e) => _(e) === i), E = t.devices.filter((e) => e.can_be_target && _(e) !== i).sort(y), fe = c && w?.area_name ? E.filter((e) => e.area_name === w.area_name) : E, D = fe.filter((e) => o.includes(_(e))), pe = ne(w, D), O = S(w, D, pe), k = D.length > 1 ? "native_group" : "direct", he = (e) => {
		let t = le.find((t) => _(t) === e), n = E.filter((e) => o.includes(_(e))), r = !!t?.area_name;
		a(e), l(r);
		...
		children: [
			...
			w && D.length ? /* @__PURE__ */ (0, m.jsxs)("fieldset", {
				...
				children: [/* @__PURE__ */ (0, m.jsx)("legend", { children: r.capabilities }), pe.length ? pe.map((e) => /* @__PURE__ */ (0, m.jsxs)("label", { children: [
					...
					/* @__PURE__ */ (0, m.jsx)("span", { children: me(e, r) }),
					/* @__PURE__ */ (0, m.jsx)("small", {
						className: re(O, e)?.supported_members === D.length ? "" : "mbs-partial",
						children: ie(re(O, e), r)
					})
			...
			p ? /* @__PURE__ */ (0, m.jsxs)("div", {
				...
				children: [
					...
					p.route === "native_group" ? /* @__PURE__ */ (0, m.jsxs)(m.Fragment, { children: [
						/* @__PURE__ */ (0, m.jsx)(T, { members: p.targets }),
						/* @__PURE__ */ (0, m.jsx)(de, {
							coverage: p.coverage,
							t: r
						}),
		...
		children: [
			/* @__PURE__ */ (0, m.jsxs)("section", { children: [
				...
				e.relationships.length ? /* @__PURE__ */ (0, m.jsx)("div", {
					className: "mbs-list",
					children: e.relationships.map((e) => /* @__PURE__ */ (0, m.jsx)(le, {
						relationship: e,
						t
					}, e.id))
				}) : /* @__PURE__ */ (0, m.jsx)(D, { text: t.noRelationships })
			] }),
			/* @__PURE__ */ (0, m.jsxs)("section", { children: [
				/* @__PURE__ */ (0, m.jsx)(fe, {
					title: t.controlSets,
					...
					children: e.native_control_sets.map((e) => /* @__PURE__ */ (0, m.jsxs)("article", {
						...
						children: [
							/* @__PURE__ */ (0, m.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, m.jsx)("strong", { children: e.name }), /* @__PURE__ */ (0, m.jsx)(ue, {
									clusters: e.clusters,
									t
								})]
							}),
							...
							/* @__PURE__ */ (0, m.jsx)(T, { members: e.members })
						]
					}, e.group_id))
				}) : /* @__PURE__ */ (0, m.jsx)(D, { text: t.noControlSets })
			] }),
			/* @__PURE__ */ (0, m.jsxs)("section", { children: [
				/* @__PURE__ */ (0, m.jsx)(fe, {
					title: t.capacity,
...
function le({ relationship: e, t }) {
	let n = e.targets.members, r = e.route === "native_group" ? e.targets.name : n[0] ? b(n[0]) : e.targets.name;
		...
		children: [
			/* @__PURE__ */ (0, m.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, m.jsxs)("div", {
					className: "mbs-route",
					children: [
						/* @__PURE__ */ (0, m.jsx)(w, { endpoint: e.source }),
						/* @__PURE__ */ (0, m.jsx)("span", {
							"aria-hidden": "true",
							children: "→"
						}),
			...
			e.route === "native_group" ? /* @__PURE__ */ (0, m.jsx)(T, { members: n }) : null
		]
	});
}
function w({ endpoint: e }) {
	return /* @__PURE__ */ (0, m.jsx)("div", { children: /* @__PURE__ */ (0, m.jsx)("strong", { children: b(e) }) });
}
function ue({ clusters: e, t }) {
	return e.length ? /* @__PURE__ */ (0, m.jsx)("div", {
		className: "mbs-chips",
		children: e.map((e) => /* @__PURE__ */ (0, m.jsx)("span", { children: me(e, t) }, e))
	}) : null;
}
function de({ coverage: e, t }) {
	return e.length ? /* @__PURE__ */ (0, m.jsx)("div", {
		...
		children: e.map((e) => /* @__PURE__ */ (0, m.jsxs)("p", {
			...
			children: [
				/* @__PURE__ */ (0, m.jsx)("strong", { children: me(e.cluster_id, t) }),
				" · ",
				ie(e, t),
...
customElements.define("matter-binding-studio-panel", k);
//#endregion
